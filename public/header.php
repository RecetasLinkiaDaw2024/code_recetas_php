            ...
            <ul>
                <li class="dropdown">
                    ...
                    <div class="dropdown-content">
                        <a href="<?= DEPLOY_PATH?>/misDatos/misDatos.php">Mis datos</a>
                        <a href="detalle_receta.php">Mis recetas</a>
                        <a href="<?= DEPLOY_PATH?>/recetas/listado.php">Buscador de recetas</a>
                        <?php
                        ...
                        ?>
                        <a href="<?= DEPLOY_PATH?>/public/logout.php">Cerrar sesión</a>
                    </div>
                </li>
            </ul>
        </nav>
